...
lexicon = helper_functions.get_lexicon(corpus, constants.N_GRAMS, constants.OCCURRENCES_TO_DISCARD)
n_grams_dictionary = n_grams.create_n_grams(corpus, constants.N_GRAMS, lexicon)
